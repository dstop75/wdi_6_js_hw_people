...
Person.prototype = {
    ...
    removeFriend: function(friendFullName) {
        function notMatching(element) {
            return element.fullName() !== friendFullName;// return true for all friends whose names don't match
        }
        this.friends = this.friends.filter(notMatching);// keep all friends whose names don't match
    },
